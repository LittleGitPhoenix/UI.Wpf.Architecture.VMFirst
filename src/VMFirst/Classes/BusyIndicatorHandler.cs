...
namespace Phoenix.UI.Wpf.Architecture.VMFirst.Classes
{
	...
	public class BusyIndicatorHandler : IBusyIndicatorHandler
	{
		...
		{
			_busyMessages = new ConcurrentStack<string>();
		...
		private void Show(string message, bool overrideCurrent)
		{
			...
			if (overrideCurrent) _busyMessages.TryPop(out obsoleteMessage);
		...
		public void Revoke()
		{
			_busyMessages.TryPop(out var obsoleteMessage);
		...
		//	this.Test(() =>
		//	{
		//		Debug.WriteLine("No waiting.");
		//	});
			
		//	this.Test(() =>
		//	{
		//		Task.Delay(200);
		//		Debug.WriteLine("Waited 0ms because waiting occurred in a separat task.");
		//	});

		//	this.TestAsync(async () =>
		//	{
		//		await Task.Delay(200);
		//		Debug.WriteLine("Waited 200ms.");
		//	}).Wait();

		//	await this.TestAsync(() =>
		//	{
		//		Debug.WriteLine("200ms until finished message.");
		...
		//private void Test(Action method)
		//{
		//	method.Invoke();
		//	Debug.WriteLine("Method finished.");
		//}

		//private async Task TestAsync(Func<Task> asyncMethod, CancellationToken cancellationToken = default)
		//{
		//	if (!cancellationToken.IsCancellationRequested)
		//	{
		...
		//	};
		//}
		//private async Task TestAsync(Func<CancellationToken, Task> asyncMethod, CancellationToken cancellationToken = default)
		//{
		//	if (!cancellationToken.IsCancellationRequested)
		//	{
		//		await asyncMethod.Invoke(cancellationToken);
		//		Debug.WriteLine("Method finished.");
		//	};
		//}
